        ...
        <div className="max-w-7xl mx-auto px-4 py-3 md:px-6 md:py-4">
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-88 md:space-x-8">
                    ...
                    <div>
                        <span className=" text-x1 font-bold text-white md:text-4xl">
                            PsiLua
                        </span>
                        <p className="text-xs text-white font-medium hidden sm:block md:text-4x1">
                        Sistema Psicologico
                        </p>
                    </div>
                </div>
                ...
                <div className="flex items-center space-x-3 md:space-x-4">
                    {navLink.slice(0, -1).map(link => (
                        <Link
                          key={link.to}
                          to={link.to}
                          className={`hidden text-white sm:block font-medium transition-colors text-sm  md:text-base ${
                            isActive(link.to)
                              ? 'text-white/50'
                    ...
                    <Link to="/login">
                        <button className="text-white px-3 py-2 md:px-4 rounded-lg font-medium hover:shadow-lg transition-all duration-300 text-sm md:text-base">
