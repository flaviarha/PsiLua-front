 ...
 */
  ...
  */
 const STORAGE_KEYS = {
   USERS: 'psilua_users',           // Usuários do sistema (psicólogos e pacientes)
   PATIENTS: 'psilua_patients',     // Dados detalhados dos pacientes
   APPOINTMENTS: 'psilua_appointments', // Agendamentos e sessões
   REQUESTS: 'psilua_requests'      // Solicitações de novos pacientes
 };
